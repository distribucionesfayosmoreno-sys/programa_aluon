...
@Component
public class AbatibleDosCutlistGenerator implements DoorCutlistGenerator {
    ...
    public AbatibleDosCutlistGenerator(
    ...
    public List<CutlistLine> generate(CutlistRequestDto request) {
        ...
        if (marcoSuperior) {
            if (unevenness.present()) {
                if (perfilPuerta == 50) {
                    ...
                    modelRules.addMarcoInteriorDobleWithUnevenBottom(items, modelo, medidaAnchoInterior, medidaAlturaInterior, unevenness);
                } else {
                ...
                if (perfilPuerta == 50) {
                    ...
                    lineFactory.addItem(items, "Larguero Horizontal Sup 50x50 con pestaña con corte recto inglete 45º Contrario", 1, ancho);
                    modelRules.addMarcoInteriorDoble(items, modelo, medidaAnchoInterior, medidaAlturaInterior);
                } else {
        ...
        lamaAppender.addDoubleLeafLamas(
                items,
                modelo,
                numeroDeLamasEntero,
                lamaRestante,
        ...
        if (refuerzo) {
            if (modelo == DoorModel.INOX) {
                lineFactory.addItem(items, "Tubo 50x50 Refuerzo Motor Inoxidable", 2, (medidaAnchoInterior / 2.0) + 80);
            } else {
                lineFactory.addItem(items, "Tubo 40x15 Refuerzo Motor", 2, (medidaAnchoInterior - (restaRefuerzoMotor * 2)) / 2.0);
            }
        }
