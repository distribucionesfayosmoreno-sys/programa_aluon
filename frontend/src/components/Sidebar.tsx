...
export type ModuleKey = 'dashboard' | 'clientes' | 'ordenes' | 'ajustes' | 'administracion';
  ...
  >
    ...
    <nav className="flex-1 px-3 space-y-1">
      ...
      <NavItem label="Administración" active={activeModule === 'administracion'} onClick={() => onSelect('administracion')} icon={
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm0 2c-3.314 0-6 1.79-6 4v2h12v-2c0-2.21-2.686-4-6-4zm7-9h-3m3 4h-3" />
        </svg>
      } />
    </nav>
